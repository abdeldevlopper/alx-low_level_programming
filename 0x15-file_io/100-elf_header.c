 ...
 *
 * Desc:  exit code 98. only if If the file is not ELF file -
 */
...
/**
 * celf - Closes elf file.
 * @elf: The file descriptor of the ELF file.
 *
 * Desc: If the file cannot be closed - exit code 98.
 * Return: NOTHING
 */
void celf(int elf)
{
 ...
 *
 *
 * Desc:  exit code 98 If the file is not an ELF File or
 * the function fails
 *  * Return: 0 on success.
 */
